...
For a good model, the values should be more or less randomly distributed. Like the first residuals v fitted plot, there is no discernible pattern to the plot.
